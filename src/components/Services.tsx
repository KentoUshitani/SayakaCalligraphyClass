            ...
            <div className="max-w-7xl mx-auto">
                            ...
                            <div className="p-6 sm:p-8 space-y-5 sm:space-y-6">
                                <div className="flex items-start gap-3 sm:gap-4">
                                    ...
                                    <div className="flex-1">
                                        <h3 className="text-2xl sm:text-3xl font-serif font-bold text-sumi mb-1">
                                            {t(s.student.title, lang)}
                                        </h3>
                                        <p className="text-sm sm:text-base text-sumi/50">{t(s.student.subtitle, lang)}</p>
                                    </div>
                                </div>
                                <div className="space-y-3">
                                    <ul className="space-y-2 text-base sm:text-lg text-sumi/80">
                                        <li className="flex items-baseline gap-2">
                                            ...
                                            <span>{t(s.student.monthly, lang)}<strong className="text-kaede font-serif text-xl sm:text-2xl">{t(s.student.monthlyPrice, lang)}</strong></span>
                                        </li>
                                        <li className="flex items-baseline gap-2">
                                            <span className="w-1.5 h-1.5 bg-kaede rounded-full flex-shrink-0 mt-2"></span>
                                            <span>{t(s.student.single, lang)}<strong className="text-kaede font-serif text-xl sm:text-2xl">{t(s.student.singlePrice, lang)}</strong></span>
                                        </li>
                                    </ul>
                            ...
                            <div className="p-6 sm:p-8 space-y-5 sm:space-y-6">
                                <div className="flex items-start gap-3 sm:gap-4">
                                    ...
                                    <div className="flex-1">
                                        ...
                                        <p className="text-sm sm:text-base text-sumi/50">{t(s.adult.subtitle, lang)}</p>
                                    </div>
                                </div>
                                <div className="space-y-3">
                                    <ul className="space-y-2 text-base sm:text-lg text-sumi/80">
                                        <li className="flex items-baseline gap-2">
                                            <span className="w-1.5 h-1.5 bg-kaede rounded-full flex-shrink-0 mt-2"></span>
                                            <span>{t(s.adult.monthly, lang)}<strong className="text-kaede font-serif text-xl sm:text-2xl">{t(s.adult.monthlyPrice, lang)}</strong></span>
                                        </li>
                                        <li className="flex items-baseline gap-2">
                                            <span className="w-1.5 h-1.5 bg-kaede rounded-full flex-shrink-0 mt-2"></span>
                                            <span>{t(s.adult.single, lang)}<strong className="text-kaede font-serif text-xl sm:text-2xl">{t(s.adult.singlePrice, lang)}</strong>{t(s.adult.singleNote, lang)}</span>
                                        </li>
                                        <li className="flex items-baseline gap-2">
                                            <span className="w-1.5 h-1.5 bg-kaede rounded-full flex-shrink-0 mt-2"></span>
                    ...
                    <AnimatedSection delay={0.3}>
                        <div className="bg-white rounded-lg p-6 sm:p-8 shadow-lg space-y-5 sm:space-y-6 h-full">
                            <div className="flex items-start gap-3 sm:gap-4">
                                ...
                                <div className="flex-1">
                                    <h3 className="text-2xl sm:text-3xl font-serif font-bold text-sumi mb-2">
                            ...
                            <div className="border-t border-sumi/10 pt-4">
                                ...
                                <p className="text-base sm:text-lg text-sumi/70 leading-relaxed mt-3">
                ...
                <div className="mt-4 sm:mt-8">
                    <AnimatedSection className="text-center mb-10 sm:mb-12">
                        ...
                        <h2 className="text-4xl sm:text-5xl md:text-6xl font-serif font-bold text-sumi mb-4">
                    ...
                    <AnimatedSection delay={0.15}>
                        <div className="max-w-3xl mx-auto bg-white rounded-lg p-8 sm:p-10 shadow-lg space-y-6 sm:space-y-8">
                            ...
                            <div className="border-t border-sumi/10 pt-6">
                                <ul className="space-y-3 text-base sm:text-lg text-sumi/80">
                                ...
                                <p className="mt-4 text-sm sm:text-base text-sumi/50 text-center">
                            ...
                            <div className="border-t border-sumi/10 pt-6 text-center space-y-5">
                                <p className="text-base sm:text-lg text-sumi/60 text-center">{t(s.commission.igLabel, lang)}</p>
                                <a
                                ...
                                >
                                    <Instagram size={22} />
                                    <span className="text-base sm:text-lg">{t(s.commission.igFollow, lang)}</span>
                                </a>
                                <div className="text-center space-y-2">
                                    <p className="text-base sm:text-lg text-sumi/60">{t(s.commission.lineLabel, lang)}</p>
                                    <a href="https://lin.ee/edtrcMJ" className="inline-block">
                                        <img
                                            src="https://scdn.line-apps.com/n/line_add_friends/btn/ja.png"
                                            alt={t(s.addFriend, lang)}
